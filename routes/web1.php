...
Route::group(['middleware' => ['studentLogin']], function(){
      ...
      // ============================= STUDENT ROUTES WEB PAGES ENDS HERE =====================================
...
Route::group(['middleware' => 'auth.check'], function () {
   ...
   Route::group(['middleware' => 'App\Http\Middleware\SuperAdminMiddleware'], function()
   {
      ...
      Route::get('print-teacher-assign-subject/{id}', 'TeacherController@PrintTeacherAssignSubjects');
      ...
      // Route::get('view/fee/collection', 'FeeController@StudentFeeListCollectionPayment');
      ...
      Route::get('/student/fee/collection/payment', ['as' => 'FeeCollectionPayment', 'uses' => 'FeeController@FeeCollectionPayment']);
      Route::get('/fee/list/collection/payment', ['as' => 'StudentFeeListCollectionPayment', 'uses' => 'FeeController@StudentFeeListCollectionPayment']);
      ...
      // Route::get('/student/fee/list/collection/payment', ['as' => 'StudentFeeCollectionPayment', 'uses' => 'FeeController@StudentFeeCollectionPayment']);

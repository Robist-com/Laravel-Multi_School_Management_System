    ...
    <div class="row no-print">
        <div class="col-xs-12">
          <button type="button" class="btn btn-danger pull-right" >
            <a href="{{ url('pdf-download-class-single', [$class->id])}}" style="color:#fff"><i class="fa fa-download"></i> Generate PDF</a>
          </button>
        ...
        <div class="col-xs-12 table-responsive" style="margin-left: 10px;padding-right: 50px;">
          <table class="table table-striped" style="margin-left:8px;">
            ...
            <th style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;">Class Name</th>
            <th  style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;">Class Code</th>
            </tr>
            <h3 style="text-align:center; font-size: bold; font-width:30px;font-weight: 600;text-transform: uppercase;"> <b style="color:red">Class</b> <b style="color:brown">of</b> {!! $class->class_name !!} </h3>
                    <tr>
                    <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">{!! $class->class_name !!} </td>
                    <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">{!! $class->class_code !!} </td>
                    </tr>

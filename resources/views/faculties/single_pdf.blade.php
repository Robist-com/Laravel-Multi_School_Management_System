    ...
    <div class="table-responsive">
      <div class="col-sm-4 invoice-col" style="margin-left: 40px;" >
        ...
        <div class="col-xs-12 table-responsive" style="margin-left: 40px;">
          ...
          <tr>
          <td style="text-align:center; border-right:1px1 solid;border-bottom:1px solid;
                  border-top:1px solid;border-left:1px1 solid;" class="col-md-3 pull">{!! $faculty->faculty_name !!} </td>
          <td style="text-align:center; border-right:1px1 solid;border-bottom:1px solid;
                  border-top:1px solid;border-left:1px1 solid;" class="col-md-2 pull">{!! $faculty->faculty_code !!} </td>
          <td style="text-align:center; border-right:1px1 solid;border-bottom:1px solid;

    ...
    <div class="row no-print">
        <div class="col-xs-12">
          <button type="button" class="btn btn-danger pull-right" >
            <a href="{{ url('pdf-download-faculty-single', [$faculty->faculty_id])}}" style="color:#fff"><i class="fa fa-download"></i> Generate PDF</a>
          </button>
      ...
      <!-- </div> -->
        ...
        <div class="col-xs-12 table-responsive" style="margin-left: 10px;padding-right: 50px;">
          <table class="table table-striped" style="margin-left:8px;">
            <thead>
            <h3 style="text-align:center; font-size: bold; font-width:30px;font-weight: 600;"> <b style="color:red">Faculty</b>  {!! $faculty->faculty_name !!} </h3>

                    <tr>
                    <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">{!! $faculty->faculty_name !!} </td>
                    <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;" class="col-md-2 pull">{!! $faculty->faculty_code !!} </td>
                    <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
                            border-top:1px solid;border-left:1px solid;"class="col-md-2 pull">@if($faculty->faculty_status == 1)  Active @else In-Active @endif </td>
                    </tr>

    ...
    <div class="modal-dialog" style="width:90%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="school_id" id="school_id">
                                    ...
                                    <option value="{{ $school->id }}"
                                        @if(isset($classes)){{$classes->school_id == $school->id ? 'selected' : ''}}
                                        @endif>
                                        {{$school->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="semester_id" id="semester_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select " name="degree_id" id="degree_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="faculty_id" id="faculty_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="department_id" id="department_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="class_id" id="class_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="course_id" id="course_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="shift_id" id="shift_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="classroom_id" id="classroom_id1">
                                    <option value="">Select ClassRoom</option>
                                    @foreach($classroom as $room)
                                    <option value="{{$room->classroom_id}}">
                                        {{$room->classroom_name}}__{{$room->classroom_code}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="batch_id" id="batch_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="day_id" id="day_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="time_id" id="time_id1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control bootstrap-select" name="teacher_id" id="teacher_id">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">
                                    Start Date <b class="error"> *</b>
                                </label>
                                <div class='input-group date' id='myDatepicker1'>
                                    <input type='text' class="form-control bootstrap-select" name="start_date"
                                        id="start_date1" autocomplete="off" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">
                                    End Date <b class="error"> *</b>
                                </label>
                                <div class='input-group date' id='myDatepicker2'>
                                    <input type='text' class="form-control bootstrap-select" name="end_date"
                                        id="end_date1" autocomplete="off" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">
                                    Status <b class="error"> *</b>
                                </label>
                                    <select class="form-control bootstrap-select" name="status" id="status1">
                ...
                <button type="submit" class="btn bg-teal btn-sm btn-round">Generate Create Schedule</button>
            </div>
                            </div>
                        </div>

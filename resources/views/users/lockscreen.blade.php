...
<body style="background-color:#d2d6de">
    ...
    <div class="lockscreen-wrapper">
        ...
        <!-- User name -->
        <div class="lockscreen-name" style="margin-top:10px; text-align:center"><i class="badge badge-info">{{ $user->name }}</i></div><br>
        ...
        <div class="lockscreen-item">
            ...
            <form action="{{ route('login-action') }}" class="lockscreen-credentials" method="post">
                ...
                <input type="hidden" name="user_name" value="{{ !empty($user) ? $user->email : '' }}">

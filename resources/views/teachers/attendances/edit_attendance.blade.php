    ...
    <div class="panel-default">
        <div class="panel-heading">
            <div class="col-md-2 pull-right">
                <input type="text" name="class_name"  id="class_nam" class="form-control edit_atten"
                value="{{$edited_date->class_name}}" disabled >
            </div>
            <div class="col-md-2 pull-right">
            <input type="text" name="semester_name"  id="semester_nam" class="form-control edit_atten"
            ...
            <div class="panel-body">
                ...
                {{-- <hr class="line"> --}}
                  ...
                  <div class="col-md-2">
                          ...
                          <input type="text" name="attendance_date"  id="attendance_dat" style="margin-left:240%;"
                          class="form-control" value="{{$edited_date->attendance_date}}" disabled >
                        </div>
...
{{--  PLEASE WRITE THE CODE STEP BY STEP OKAY --}}

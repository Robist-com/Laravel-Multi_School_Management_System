...
@section('content')
    <section class="content-header">
        <h1 class="pull-right">
           <a data-toggle="modal" data-target="#level-add"  id="add-more-level" class="btn btn-success pull-right" style="margin-top: -10px;margin-bottom: 5px"> <i class="fa fa-plus">Add New Salaries </i></a>
        </h1>
        {{-- -----------------------------PDF BUTTON--------------------- --}}
<div class="btn btn-group" style="margin-top:20px; float:left; margin-right:-25px;  ">
        ...
        <li id="export-to-pdf">
        <a href="{{url('pdf-download-level')}}" class="btn btn">Download PDF</a>
        </li>
...
<i class="fa fa-level-up">Salaries </i></h1>
    </section>
    <div class="content">

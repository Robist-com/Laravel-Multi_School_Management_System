  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col" style="margin-left: 40px;">
        <address>
          <h3 style="font-weight:300;font-size: 15px; font-style:bold"><b>Address, LUB School.</b></h3>
      ...
      <!-- </div> -->
        ...
        <h3 style="text-align:center; font-size: bold; font-width:30px;font-weight: 600;"> <b style="color:red">Teacher</b>  {!! Auth::user()->name !!} (Assigned Subjects)  </h3>
        ...
        <div class="col-xs-12 table-responsive" style="margin-left: 10px;padding-right: 50px;">
          <table class="table table-striped" style="margin-left:8px;">
            ...
            <tr>
              ...
              border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">Subjects </th> 
              <th style="text-align:center; border-right:1px solid;border-bottom:1px solid;
              border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">Code</th>
              <th style="text-align:center; border-right:1px solid;border-bottom:1px solid;
              border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">Class</th>
              <th style="text-align:center; border-right:1px solid;border-bottom:1px solid;
              border-top:1px solid;border-left:1px solid;" class="col-md-2 pull">Grade</th>
              
              </tr>
              @foreach($teachers as $teacher)
              <tr>
              <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
              border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">{!! $teacher->course_name !!} </td>
							 <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
              border-top:1px solid;border-left:1px solid;" class="col-md-3 pull"> {!! $teacher->course_code !!}</td>
							 <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
              border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">{!! $teacher->class_name !!} </td>
							 <td style="text-align:center; border-right:1px solid;border-bottom:1px solid;
               border-top:1px solid;border-left:1px solid;" class="col-md-3 pull">{!! $teacher->semester_name !!} </td>
                </tr>
                @endforeach
							</table>

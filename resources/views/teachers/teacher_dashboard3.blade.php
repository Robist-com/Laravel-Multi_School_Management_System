...
<div class="block-header">
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        <div class="icon">
                            <a href="{{url('all/student/list')}}"><i class="material-icons">school</i></a>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        <div class="icon">
                        <a href="{{route('PromoteStudents')}}"><i class="material-icons">help</i> view promote students</a>  
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        <div class="icon">
                           <a href="{{route('teachers.index')}}"> <i class="material-icons">forum</i></a>
                        </div>
                        <div class="content">
                            <div class="text">REPEATERS</div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        <div class="icon">
                            <a href="{{route('teachers.index')}}"><i class="material-icons">person_outline</i></a>
                        </div>
                        <div class="content">
                            <div class="text">TEACHERS</div>
                            <div class="number count-to" data-from="0" data-to="{{$teachersCount}}" data-speed="15" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">ACCOUNTANTS</div>
                            <div class="number count-to" data-from="0" data-to="{{$studentsCount}}" data-speed="15" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row dash-row">
                        <div class="col-xl-4">
                            <div class="stats stats-primary">
                                <h3 class="stats-title"> Class Incharge </h3>
                                <div class="stats-content">
                                    ...
                                    <div class="stats-data">
                                        ...
                                        <div class="stats-change">
                                           <a href="{{url('/classincharge')}}"><span class="stats-percentage"><button class="btn btn-sm text-white">View Class</button></span></a> 
                        ...
                        <div class="col-xl-4">
                            <div class="stats stats-success ">
                                <h3 class="stats-title"> Students Incharge </h3>
                                <div class="stats-content">
                                    <div class="stats-icon">
                                    ...
                                    <div class="stats-number"></div>
                                        <div class="stats-change">
                                        <a href="{{url('/studentsincharge')}}"><span class="stats-percentage"><button class="btn btn-sm text-white">View Students</button></span></a> 
                        ...
                        <div class="col-xl-4">
                            <div class="stats stats-danger">
                                <h3 class="stats-title"> Parents Contact</h3>
                                <div class="stats-content">
                                    <div class="stats-icon">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card easion-card">
                                <div class="card-header">
                                    ...
                                    <div class="easion-card-title"> Attendance Chart</div>
                        ...
                        <div class="col-xl-6">
                            <div class="card easion-card">
                                <div class="card-header">
                                    <div class="easion-card-icon">
                                        <i class="fas fa-notice-board"></i>
                                    </div>
                                    <div class="easion-card-title"> Notice Board </div>
                                </div>
                                <div class="card-body ">

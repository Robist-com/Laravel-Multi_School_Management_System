<div id="myDiv">
    <ul class="nav nav-pills">
        ...
        <li><a data-toggle="tab" href="#menu1" style="font-size:12px">GRADE 2</a></li>
        @endif
        @endforeach
        ...
        @if ($schedule_teacher && Auth::user()->teacher_id)
        @foreach($enable_grade as $grade) 
        @if($grade->status == 'on' && $grade->id == '7') 
        <li ><a data-toggle="tab" href="#menu6" style="font-size:12px">GRADE 7</a></li>
        @endif
        @endforeach
        @endif

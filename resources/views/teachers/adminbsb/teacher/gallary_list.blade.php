              ...
              <tr>
                  <div class="col-md-3">
                    ...
                    <div class="card__content">
                        ...
                        <img  src="{{asset('teacher_images/' .$teacher->image)}}" alt="" class="img">
                        <h5 class="card__title">{{$teacher->first_name ." ". $teacher->last_name}}</h5>
                        <p class="card__subtitle">Teacher</p>
                        </div> 
                        
                        <div class="card__back">
                        <p class="card__body">{{$teacher->department_name}}</p>
                        <span>{{$teacher->first_name ." ". $teacher->last_name}}</span>
                        <div class="clearfix"></div>
                        {!! Form::open(['route' => ['teachers.destroy', $teacher->teacher_id], 'method' => 'delete']) !!}
                        <div class="sm card__body">
                        <a href="{!! url('student/fee/list/collection/payment', [$teacher->student_id]) !!}" class="btn  btn-xs" title="Pay Fee"><i class="fa fa-usd"></i></a>
                        ...
                        data-target="#demo{{$key}}" title="View"><span class="fa fa-eye"></span></a>
                            ...
                            <a href="{!! url('student/fee/list/collection/payment', [$teacher->student_id]) !!}" class="btn btn-xs" title="Promote Student"><i class="far fa-paper-plane"></i></a>

    ...
    <thead>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a id="cursor" class='btn btn-daek btn-round btn-xs' data-toggle="tooltip" data-placement="left" title="Edit {{$mark->first_name}} {{$mark->last_name}} mark" href='{{url("/teacher/mark/edit")}}/{{$mark->id}}'> <i class="glyphicon glyphicon-edit icon-white"></i></a>
          </td>
          @endforeach
        </tbody>
      </table>

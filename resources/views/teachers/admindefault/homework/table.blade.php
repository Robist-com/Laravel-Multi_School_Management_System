...
@foreach($class_assign as $grade) 
    ...
    <input type="hidden" name="school_id" id="school_id" value="{{auth()->user()->school->id}}" class="form-control" placeholder="Enter Subject ">
                  ...
                  <div class="control-group col-md-6">
                            <div class="controls">
                              <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                <input name="start_date" id="start_date" type="text" class="form-control has-feedback-left" id="single_cal4" placeholder="First Name" aria-describedby="inputSuccess2Status4" autocomplete="off">
                          ...
                          <div class="control-group col-md-6">
                            <div class="controls">
                              <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                <input name="end_date" id="end_date" type="text" class="form-control has-feedback-left" id="single_cal5" placeholder="First Name" aria-describedby="inputSuccess2Status5" autocomplete="off">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>

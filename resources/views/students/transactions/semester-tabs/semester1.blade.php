        ...
        <div class="panel-heading">
            <div class="card">
                <h3 style="text-transform:uppercase; font-weight:bold; margin-left:30%;">
                    @if(isset($class_name))Grade 1 <b style="color:red">TRANSACTIONS</b></h3>
                @else
                <b style="color:red">TRANSACTIONS</b></h3>
                @endif
            </div>
        </div>
    </div>
        ...
        <table class="bordered-table">
            <thead>
                <tr class="bordered-tr">
                    ...
                    <th class="bordered-th">Amount ($)</th>
            ...
            <tbody>
                ...
                <tr class="bordered-tr">
                    <td class="bordered-td" style="text-align: center;background-color:#34495E; color:#fff">{{++$n}}
                    </td>
                    ...
                    <td class="bordered-td" style="text-align: center;"><span class="fa fa-usd"></span>
                    ...
                    <td style="text-align: center;width:112px;">
                        <a href="{{ route ('StudentInvoicePrint', [$transaction->invoice_id])}}" target="_blank"
                            class="btn btn-info btn-xs"><i class="fa fa-print" title="Print"></i></a>
                    </td>
                    @endif
                    @endforeach
                    @else

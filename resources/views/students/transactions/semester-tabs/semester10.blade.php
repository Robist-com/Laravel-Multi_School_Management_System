          ...
          <div class="panel-heading">
            <div class="card">
              <h3 style="text-transform:uppercase; font-weight:bold; margin-left:30%;">
                @if(isset($class_name))Grade 10 <b style="color:red">TRANSACTIONS</b></h3>
                @else
                ...
                <tbody>
                    ...
                    @if ($transaction->semester_id == 10)
                            ...
                            <tr class="bordered-tr">
                                ...
                                <td class="bordered-td" style="text-align: center;"><span class="fa fa-usd"></span> {{number_format($transaction->amount,2)}}</td>

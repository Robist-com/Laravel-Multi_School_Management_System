<div class="tab-content">
    <div class="tab-pane fade active in" id="activity">
        <div class="tabbable">
          @include('students.timetable.semester-tabs.tabs-header')
            <div class="tab-content">
                {{-- semester 1 tab --}}
              ...
              <div id="menu0" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester1')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu1" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester2')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu2" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester3')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu3" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester4')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu4" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester5')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu5" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester6')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu6" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester7')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu7" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester8')
              </div>
              @endif
              @endforeach
                {{-- semester 9 tab --}}
               ...
               <div id="menu8" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester9')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu9" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester10')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu10" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester11')
              </div>
              @endif
              @endforeach
               ...
               <div id="menu11" class="active tab-pane in fade">
                ...
                <hr class="line">
                @include('students.timetable.semester-tabs.semester12')
              </div>
              @endif
              @endforeach
            </div>

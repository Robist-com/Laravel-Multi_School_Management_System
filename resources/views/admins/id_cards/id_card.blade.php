...
<body>
    ...
    <div class="page-header" style="text-align: center">
        ...
        <button type="button" id="print_content" onClick="window.print()" class="print_button">
           Print
        </button>
                ...
                <div class="id-card-hook"></div> -->
                            ...
                            <div class="id-card-holder">
                                ...
                                <div class="id-card">
                                    ...
                                    <div class="signature">
                                        <img
                                            src="{{asset('certificate_template/school_images/' .$card->school_signature)}}">

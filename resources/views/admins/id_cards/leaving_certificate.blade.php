<div class="col-md-12">
  <button id="print_content" style="width:1600px;" class="btn btn-info btn-lg btn-block "  onclick="Printcontent('divide')"><span class="glyphicon glyphicon-search">Print</span></button>
  </div>
    <div class="row" id="divide">
    @foreach($institute as $card)
<div>
...
background-image: url('school_images/signature/certificate_frame3.png');

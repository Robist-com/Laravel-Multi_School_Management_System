...
@section('content')
  ...
  <div class="card">
      <div class="row">
           ...
           <div class="col-md-12">
             <form action="" autocomplete="off">
               <label for="">Search by Roll no / Teacher First Name / Teacher Last Name</label>
      ...
      {{-- <div class="card-header"><h4>All teachers</h4></div> --}}
      <div class="card-body">
        @if (Request('search'))
           <table class="table table-striped jambo_table bulk_action">
              ...
              <tbody>
                 @foreach ($teachers as $key => $student)
                    <tr>
                        <td>{{ $key+1}}</td>
                        <td style="text-align: left !important"><img width="50" height="50" class="round"  src="{{ $student->image != '' ? asset('teacher_images/' .$student->image) : asset('student_images/profile.jpg') }}" }} alt=""> {{ $student->roll_no}}</td>

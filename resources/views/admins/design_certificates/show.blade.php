...
<div class="col-md-12">
  <button id="print_content"  class="btn btn-info btn-lg btn-block "  onclick="Printcontent('divide')"><span class="glyphicon glyphicon-search">Print</span></button>
    ...
    @foreach($show_certificate as $card)
<div>
                ...
                <div class="col-xs-10">
                    ...
                    <div class="box">
                        ...
                        <div class="certificate_information">
                            ...
                            <h1 class="certificate_holder_name"> @if($card->first_name != '' && $card->last_name != '') {{$card->first_name .' '. $card->last_name}} @else HOLDER NAME [Firstname and lastname] @endif</h1>
                            <p>
...
@foreach($show_certificate1 as $cert_design)

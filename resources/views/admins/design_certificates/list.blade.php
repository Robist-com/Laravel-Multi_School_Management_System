...
@media (max-width: 768px) {
  ...
  <h2 style='margin-left:8.5%;'>Gallary</h2>
    <div class="gallery row">
      <!-- 3 -->
      @foreach($list_certificate as $gallary)
      <div class="gallery-list col-md-16 col-xs-6">
        <div class="image-grid">

          <!-- <img src="{{asset('school_images/media_manager/' )}}"> -->
          @include('admins.design_certificates.certificate_modal')

...
@section('content')
    <section class="content-header">
        <h1 class="pull-right">
           <a  href="{{url('home')}}" class="btn btn-default pull-right" style="margin-top: -10px;margin-bottom: 5px"><i class="fa fa-plus-circle" aria-hidden="true">back</i></a>
        </h1>
{{-- -----------------------------PDF BUTTON--------------------- --}}
<div class="btn btn-group" style="margin-top:20px; float:left; margin-right:-25px;  ">
        ...
        <li id="export-to-pdf">
        <a href="{{url('pdf-download-batches')}}" class="btn btn">Download PDF</a>
        </li>
...
<i class="fa fa-id-badge" aria-hidden="true"> Status </i></h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
             ...
             <div class="panel-default">
                <div class="panel-heading" style="text-transform:uppercase; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif" > Online Staff  </div>
                <div class="panel-body">
                @include('admins.online-teachers-table')
               </div>
              </div>
             </div>
              <div class="col-md-6">
             <div class="panel-default">
              <div class="panel-heading" style="text-transform:uppercase; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif" > Online Students  </div>
                <div class="panel-body">

...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="page-title">
        ...
        <a href="{{route('incometype.index')}}" class="btn bg-teal btn-sm  pull-left"><i class="material-icons">add</i>
            Add</a>

            <a class="btn bg-teal pull-right" data-toggle="modal" data-target="#income-type"><i
    ...
    <div class="row clearfix">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    @if(isset($income_type))
                    {!! Form::model($income_type, ['route' => ['incometype.update', $income_type->id], 'method' =>
                    'post', 'class' => 'form-horizontal form-label-left', 'enctype' => 'multipart/form-data']) !!}
                    @csrf
                    @else
                    {!! Form::open(['route' => 'incometype.store', 'class' => 'form-horizontal form-label-left',
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <select class="form-control" name="school_id" id="school_id">
                                ...
                                <option value="{{ $school->id }}"
                                    @if(isset($income_type)){{$income_type->school_id == $school->id ? 'selected' : ''}}
                                    @endif>
                                    {{$school->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="type" id="type" class="form-control" placeholder="Enter Type"
                                @if(isset($income_type)) value="{{$income_type->type}}" @endif autocomplete="off">
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            @if(isset($income_type))
                                <option value="1" @if($income_type->status == 1) selected @endif> Active</option>
                                <option value="0" @if($income_type->status == 0) selected @endif> In Active</option>
                                @else
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive js-exportable"
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td colspan="3">
                                        {!! Form::open(['route' => ['incometype.delete', $income->id],
                                        'method' =>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a href="{!! url('print-faculty-single', [$income->id]) !!} "
                                                        target="_blank">
                                                ...
                                                <li>
                                                    <a
                                                        href="{!! route('incometype.detail', [$income->id]) !!}">
                                                ...
                                                <li>
                                                    <a
                                                        href="{!! route('incometype.edit', [$income->id]) !!}">
                                                ...
                                                <li>
                                                    ...
                                                    <a id="delete_link" href="#"
                                                        data-confirm="Are you sure want to delete {{$income->type}} ?"><i

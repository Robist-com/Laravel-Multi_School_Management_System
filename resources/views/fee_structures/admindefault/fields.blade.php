  ...
  <div class="modal-dialog modal-notify modal-lg  modal-right " role="document">
    <div class="modal-content">
      ...
      <!-- <div class="modal-body">
        ...
        {{-- <select name="fee_type" id="fee_type" class="form-control bootstrap-select">
        <option selected>----Select Type----</option>
        @foreach(App\FeeType::where('school_id', auth()->user()->school_id)->get() as $fee_types)
        <option value="{{$fee_types->id}}" @if(isset($feeStructure)) {{$feeStructure->fee_type == $fee_types->id ? 'selected' : '' }} @endif>{{$fee_types->type}}</option>
        @endforeach
        </select> --}}

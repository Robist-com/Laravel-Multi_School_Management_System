                   ...
                   <style>
                           ...
                           <div class="col-md-5 col-sm-5 col-xs-12">
                            <!-- <div class="form-group row"> -->
                              ...
                              <!-- <div class="form-group row"> -->
                                ...
                                <div class="col-sm-9">
                                <h6  class="col-sm-10 " id="inputEmail3">{{$student->father_name}}</h6>
                                <!-- </div> -->
                              </div>
                              <!-- <div class="form-group row"> -->
                    ...
                    <div class="col-md-11 col-sm-12 col-xs-12" style="margin-left: 43px;" id="panel_fee">
                    @if(isset($fee_structure1))
                    @include('fee.fee-type')
                    @endif  
                    </div>
                    <div class="col-md-12" id="payment_submitButton">
            ...
            @include('fee.adminbsb.studentFeelist')

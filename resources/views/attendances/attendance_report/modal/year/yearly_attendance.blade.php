      ...
      <div class="card">
        <div class="panel">
          <div class="panel-heading">
            ...
            @if (isset($year_name))
              {{ $year_name->faculty_name}}
              @endif
                <br>
              </h4>
              <h2 style="text-transform:uppercase; font-weight:bold; text-align:center;">{{$institute->name}} </h2>
               <h3 style="text-transform:uppercase; font-weight:bold; text-align:center;"><b style="color:royalblue"> 
               @if (isset($year_name))
               {{ $year_name->year}}
               </b>  ATTENDANCE REPORT
               @else
               <label style="text-transform:uppercase; font-weight:bold; text-align:center;">ATTENDANCE REPORT</label></h3>
               @endif
          </div>
          <br><br>
            <br><br>

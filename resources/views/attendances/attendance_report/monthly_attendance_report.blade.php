    ...
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <h6>
                ...
                <span class="rInfo"><strong>Class: </strong> {{request('class')}}</span>
                <span class="rInfo"><strong>Session: </strong> Session 2020</span>
                <span class="rInfo"><strong>Section: </strong> Section A</span>
            ...
            <table id="attendanceList" class="table table-bordered">
                ...
                @foreach($data as $datum)
                    <tr>
                        ...
                        @foreach($keys as $index=>$key)
                            ...
                            @else
                                ...
                                @elseif(isset($offDays[$key]))
                                    ...
                                    $color = "#9229ad";
                                    ?>
                                @elseif(isset($sick[$key]))
                                    <?php
                                    $symbol = $sick[$key];
                                    $totalS++;
                                    $color = "#9229ad";
                                    ?>
                                @elseif(isset($late[$key]))
                                    <?php
                                    $symbol = $late[$key];
                                    $totalL++;
                                    $color = "#9229ad";
                        ...
                        <td>{{$totalH}}</td>
                        <td>{{$totalCO}}</td>
                        <td>{{($totalP+$totalA+$totalS+$totalL+$totalH+$totalCO)}}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>

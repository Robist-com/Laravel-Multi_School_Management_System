...
@section('content')
    <section class="content-header">
        <h1 class="pull-right">
           <a data-toggle="modal" data-target="#times-show" class="btn btn-success pull-right" style="margin-top: -10px;margin-bottom: 5px" ><i class="fa fa-plus-circle" aria-hidden="true">Add New Time</i></a>
        </h1>
     
<h1 class="pull-right" style="margin-top: -10px;margin-bottom: 5px;margin-right: 50px">
<i class="fa fa-shirtsinbulk" aria-hidden="true"> Times</i></h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <a href="{{url('pdf-download-times')}}" class="btn btn  btn-x"> 
            <i class="fa fa-file-pdf-o text-red" style="color:white"></i> PDF </a>

            <a href="{{url('export-excel-xlsx-times')}}" class="btn btn  btn-x"> 

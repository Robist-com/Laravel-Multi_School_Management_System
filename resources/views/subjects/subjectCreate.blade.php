            ...
            <div class="box-content">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-4" style="display:none">
                          ...
                          <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign  blue"></i></span>
                              <select name="type" class="form-control select_2_single" >
                      ...
                      <div class="col-md-12">
                          <div class="col-md-2" style="display:none">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign  blue"></i></span>
                                      <select name="subgroup" class="form-control select_2_single" >
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign  blue"></i></span>
                                <select name="stdgroup" class="form-control select_2_single" >
                      ...
                      <div class="col-md-4">
                            <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="class[]" class="form-control select_2_single" multiple data-hide-disabled="true" data-size="5"required >

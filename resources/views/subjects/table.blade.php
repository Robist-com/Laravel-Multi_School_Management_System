...
<table id="subjectList" class="table table-striped table-bordered table-hover">
                                                       ...
                                                       <td>
                        <a data-subject_id="{{$subject->id}}" data-subject_name="{{$subject->name}}" 
                        data-subject_class="{{$subject->class}}" data-subject_code="{{$subject->code}}"
                        data-subject_group="{{$subject->subgroup}}" data-student_group="{{$subject->stdgroup}}" 
                        data-grade_system="{{$subject->gradeSystem}}" class='btn btn-default btn-xs'
                        data-toggle="modal" data-target="#modal-role">
                        <i class="glyphicon glyphicon-eye"></i></a>

                        <!-- <a data-toggle="modal" data-target="#modal-role" id="Edit" data-subject_id="{{$subject->id}}"  class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a> -->

...
aria-hidden="true" style="margin-left: 20%;">
    <div class="modal-dialog" style="width:90%">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Generate Question Papers</h4>
            </div>
            ...
            <div class="row">
               ...
               <label for="name">Session  <b style="color:red">*</b></label>
                ...
                <label for="name">Class  <b style="color:red">*</b></label>
                    ...
                    <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    <label for="name">Subject  <b style="color:red">*</b></label>
                      @if(isset($subjects))
                    ...
                    <label for="name">Number of copies  <b style="color:red">*</b></label>
                      <input type="number" name="print" class="form-control" required placeholder="Enter Number of Copies to print">
                    </div>

                    <div class="form-group col-md-4 col-sm-4 col-xs-12">
                    <label for="name">Number of MCQ   <b style="color:red">*</b></label>
                      <input type="number" name="mcqs" class="form-control" placeholder="Enter Number  of multiple choice question " >
                    </div>

                    <div class="form-group col-md-4 col-sm-4 col-xs-12">
                    <label for="name">Number of BQ  <b style="color:red">*</b></label>
                      <input type="number" name="short" class="form-control" placeholder="Enter Number of Basic Questions ">

                    </div>

                  <div class="form-group col-md-4 col-sm-4 col-xs-12">
                  <label for="name">Number of THQ  <b style="color:red">*</b></label>
                      <input type="number" name="long" class="form-control"  placeholder="Enter Number of Theory Questions ">
                </div>

                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                <label for="name">Exam Term  <b style="color:red">*</b></label>
                ...
                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                <label for="name">Exam Level  <b style="color:red">*</b></label>
        ...
        <button type="button" class="btn btn-danger btn-round" data-dismiss="modal"><i class="fa fa-close"></i> close</button>
         <button type="submit" class="btn btn-dark btn-round"><i class="glyphicon glyphicon-check"></i> Generate Questions Paper</button>
          </div>
          </div>
          </form>
          </div>
...
// alert(template("abc"));
    ...
    var template = jQuery.validator.format(`
        <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12" id="i-{0}" style="padding-top: 10px; display: none">
 ...
 function addQuestion(){
        ...
        if(newId > 4){
           ...
           alert('you have 5 questions to create first');
        }else{
            newId++;
        }
    ...
    function removeQuestion(){
        $(this).closest('#question').remove(template(newId));
        newId-1;
    }

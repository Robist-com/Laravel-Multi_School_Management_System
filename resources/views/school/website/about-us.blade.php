            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                    <h2 class="section-title-underline mb-5">
                        <span>Why @foreach( $teachers  as $institute) {{$institute->name}} @endforeach</span>
                    </h2>
        ...
        @foreach( $teachers as $teacher)
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
            <div class="feature-1 border person text-center">
                <img src="{{asset('teacher_images/' .$teacher->image)}}" alt="Image" class="img-fluid">
              <div class="feature-1-content">
                <h2>{{$teacher->first_name .' '. $teacher->last_name}}</h2>
                <span class="position mb-3 d-block">Math Teacher</span>    
                <span class="position mb-3 d-block">{{$teacher->phone}}</span>    

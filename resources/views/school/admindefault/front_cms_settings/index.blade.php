...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7" style="margin-top: 2px">
                                <textarea name="meta_tags" id="meta_tags" cols="30" rows="3" class="form-control"></textarea>
                            </div>
                            <div class="col-md-5" style="margin-top: 2px">
                        ...
                        <div class="col-md-12">
                            <hr>
                            <label>Default Themes &nbsp;&nbsp;&nbsp;&nbsp; <span style="text-align: center; color:red !important" id="theme_number"> this one </span></label>
                            <ul class="style">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn bg-primary" id="btn_save_seetings">Save</button>
        </div>
        </form>
...
$(document).ready(function(){
    ...
    if (themeName === 'theme_orange') {
        ...
        $('#theme_number').text('ORANGE THEME SELECTED');
        ...
        $('#theme_number').text('BLUE THEME SELECTED');
        ...
        $('#theme_number').text('DARK BLUE THEME SELECTED');
        ...
        $('#theme_number').text('MARONG THEME SELECTED');

        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <h2 class="mr-title">
                    ...
                    {{$class_name->last_name }}'<sup style="color:black">s</sup> <strong style="color:black">TIME
                        TABLE</strong>
                </h2>
                @else
                <tr class="bordered-tr">
                    <td colspan="12" class=" bordered-td">
                        <div class="alert alert-danger text-center" style="font-weight:bolder">
                            ...
                            <a href="{{ route('classSchedules.index') }}"><button
                                    class="btn btn-success btn-lg pull-right">Assign TimeTable</button></a>
                        </div>
                    </td>
                </tr>
                @endif
                        ...
                        <tbody id="accordion">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;background-color:#f0f0f0"
                                    class="align-middle text-center">{{$teacher->course_name}}</td>
                                <td style="text-align: center;">@if(isset($teacher->class_name))
                                    {{ $teacher->class_name }} @endif</td>
                                <td style="text-align: center;">----</td>
                                <td style="text-align: center;">{{$teacher->classroom_name}}</td>
                                <td style="text-align: center;">{{ $teacher->semester_name}}</td>
                                <td style="text-align: center;"><a data-toggle="tooltip" data-placement="top"
                                        title="clcik to view {{$teacher->first_name}}{{$teacher->last_name}} detail"
                                        style="color:cornflowerblue" href="#"
                                        onclick="getteacherinfo('{{$teacher->teacher_id}}')">{{$teacher->first_name}}{{$teacher->last_name}}</a>
                                </td>

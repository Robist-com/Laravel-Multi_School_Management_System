        ...
        <div class="panel">
          <div class="panel-heading">
            <h3 style="text-transform:uppercase; font-weight:bold; margin-left:30%;"> 
              ...
              <sup style="text-transform:uppercase; font-weight:bold; margin-left:38%;">LATRIKUNDA UPPER BASIC SCHOOL </sup>
              ...
              <tbody>
                <tr>
                  <td colspan="0" style="text-align: left;">
                    <b>Faculty      : </b>{{ $class_name->faculty_name}}
                  </td>
                  <td></td>
                  <td colspan="0" style="text-align: right; ">
                    <b>Level        : </b>{{ $class_name->level}}
                </td>
                </tr>
                <tr>
                  <td colspan="0" style="text-align: left; ">
                    <b>Department   : </b>{{ $class_name->department_name}}
                  </td>
                  <td></td>
                  <td colspan="0" style="text-align: right; ">
                    <b>Batch        :</b>{{ $class_name->batch}}
                </td>
                </tr>
                <tr>
                  <!-- <td colspan="0" style="text-align: left; ">
                  ...
                  <td></td>
                  <!-- <td colspan="0" style="text-align: right; ">
                    <b>Grade     :</b> <sub>{{ $class_name->semester_name}}</sub>
                </td> -->
                </tr>
              </tbody>
            </table>
            ...
            <table class="bordered-table">
                <thead>
                    <tr class="bordered-tr">
                      ...
                      <th class="bordered-th">UNITE</th>
                      <th class="bordered-th">ROOM</th>
                      <th class="bordered-th">GRADE</th>
                    </tr>
                </thead>
                <tbody>
                    @if(count($teachertimetables_pdf) > 0)
                    @foreach ($teachertimetables_pdf as $teacher)
                    <tr class="bordered-tr">
                    ...
                    <tr class="bordered-tr">
                      <td colspan="12" class=" bordered-td">
                       <div class="alert alert-danger text-center" style="font-weight:bolder">
                        No TimeTble Found for {{$class_name->first_name}} {{$class_name->last_name}}
                       </div>
                      </td>
                    </tr>
                    @endif

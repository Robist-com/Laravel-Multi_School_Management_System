<hr>
                    ...
                    <div class="row">
                       <form action="{{route('poststudentReport')}}" method="POST">
                        ...
                        <select name="department" id="department" class="form-control bootstrap-select" onchange="getData(this);" @if(request('department')) selected @endif>
                        ...
                        <select name="gender" id="gender" class="form-control bootstrap-select" @if(request('gender')) selected @endif>
                            <option value="">Select</option>
                    ...
                    <b>Student Report</b>
                    <hr>
                    <table id="datatable-buttons" class="table table-striped table-bordered js-exportable js-exportable">
                      <thead>
                        <tr>
                          <th>Roll No</th>
                          <th>Student Name</th>

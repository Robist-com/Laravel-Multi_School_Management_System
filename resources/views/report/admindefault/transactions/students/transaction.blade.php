...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <h2 class="to"> @if($student_info->gender == 0)Mr. @else Mrs. @endif {{$student_info->last_name}}</h2>
                        <div class="address">Roll N<sup>o</sup> {{ $roll_no->username}}</div>
                        <div class="email"> Name: <b>{{ $student_info->first_name ." ".$student_info->last_name}}</b></div>

                        <hr>
                        <h2 class="grade_name"><b>{{$student_info->semester_name}}</b> <b style="margin-left:80%">{{$student_info->class_name}}</b></h2>
                    </div>
                    <div class="col invoice-details">
                        <h1 class="invoice-id">INVOICE N<sup>o</sup>: {{ sprintf("%05d", $student_info->invoice_id)}}</h1>
                        {{-- <div class="date">Date of Invoice: 01/10/2018</div> --}}
                        <div class="date">Date of Transaction: {{ date('d-M-Y',strtotime($student_info->transact_date))}}</div>
            ...
            <footer>
                <p style="margin-right:80%;">Cashier: {{$student_info->name}}</p>

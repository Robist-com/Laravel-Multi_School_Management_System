                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="monthly_date"  data-date-format="yyyy-mm" value="{{$yearMonth}}">
                                        </div>
                                    </div>
                                </div>
                               <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-dark btn-round pull-right"  type="submit"><i class="glyphicon glyphicon-print"></i> Get List</button>
                                        @else

            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-4">
                    <i class="fa fa-file-o"></i> <a href="{{route('getstudenthistoryReport')}}"> Student History</a>
                    </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <!-- <div class="form-group col-sm-4">
                           <i class="fa fa-file-o"></i> <a href=""> Student History</a>
                    </div> -->
                   ...
                   @include('report.student.student_report')

                    @elseif(isset($studentguidianreport))
                    @include('report.student.guadian_report')

                    @elseif(isset($studenthistoryreport))
                    @include('report.student.student_history')

                    @elseif(isset($studentlogindetailreport))
                    @include('report.student.student_login_detail')

                   
                    @elseif(isset($studentacademicreport))
                    @include('report.student.admission_report')
                    @endif
        </div>
    </div>
</div>

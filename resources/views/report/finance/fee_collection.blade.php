...
<strong>Select Criteria</strong>
                    <hr>
                    <div class="row">
                       <form action="{{route('postfee_collectionReport')}}" method="POST">
                           @csrf
                        ...
                        <button type="submit" class="btn btn-dark btn-round saerch_mode"><i class="fa fa-search"></i>search</button>
                        </div>

...
<div class="table-responsive" id="show-student-paid" >
    ...
    <thead>
        <tr>
            ...
            <th id="print-student-transaction">
            @if(isset( $students))
            <a class="btn btn-warning" target="_blank" href="{{route('StudentTransactionPrint', [$students->student_id])}}"><i class="fa fa-print"></i></a>
            @endif
            </th>
        </tr>
        <tbody>
        ...
        <a class="btn btn-info" href="{{route('StudentInvoicePrint', [$data->invoice_id])}}" target="_blank"><i class="fa fa-print"></i></a>
        </td>
        </tr>
        @endforeach
        </tbody>
